      ...
      <Container className="flex h-16 items-center justify-between gap-4 md:h-20">
          ...
          <ul className="flex items-center gap-1">
            {NAV_LINKS.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="inline-flex items-center rounded-[var(--radius-sm)] px-3.5 py-2 text-sm font-medium text-foreground-muted transition-colors duration-[var(--duration-fast)] hover:bg-surface hover:text-primary"
                >
                  {link.label}
                </Link>
              </li>
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-[var(--radius-pill)] px-3.5 py-2 text-sm font-medium text-foreground-muted transition-colors hover:text-primary"
          >
